...
def random_mini_batches(X, Y, mini_batch_size = 64, seed = 0):
    ...
    for k in range(0, num_complete_minibatches):
        ### START CODE HERE ### (approx. 2 lines)
        mini_batch_X = shuffled_X[:, k*mini_batch_size : (k+1) * mini_batch_size].reshape(X.shape[0], mini_batch_size)
    ...
    if m % mini_batch_size != 0:
        ### START CODE HERE ### (approx. 2 lines)
        mini_batch_X = shuffled_X[:,  num_complete_minibatches*mini_batch_size: m].reshape(X.shape[0], (m - num_complete_minibatches*mini_batch_size))
...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate = 0.01,
    ...
    for l in range(L):
        ...
        ### START CODE HERE ### (approx. 2 lines)
        parameters["W" + str(l+1)] = parameters["W" + str(l+1)] - learning_rate*v_corrected["dW" + str(l+1)]*(1/np.sqrt(s_corrected["dW" + str(l+1)] + epsilon))
        parameters["b" + str(l+1)] = parameters["b" + str(l+1)] - learning_rate*v_corrected["db" + str(l+1)]*(1/np.sqrt(s_corrected["db" + str(l+1)] + epsilon))
        ### END CODE HERE ###
